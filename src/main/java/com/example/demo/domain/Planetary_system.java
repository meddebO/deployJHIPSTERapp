...
public class Planetary_system implements Serializable {
    ...
    public Galaxy getGalaxy_re() {
        return galaxy_re;
    }

    public Planetary_system galaxy_re(Galaxy galaxy) {
        this.galaxy_re = galaxy;
        return this;
    }

    public void setGalaxy_re(Galaxy galaxy) {
        this.galaxy_re = galaxy;
    }
